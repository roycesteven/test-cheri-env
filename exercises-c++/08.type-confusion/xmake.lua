...
compartment("type-confusion")
    ...
    add_files("type-confusion.cc")

-- Firmware image for the example.
firmware("type-confusion-vulnerability")
    add_deps("freestanding", "debug", "stdio", "type-confusion")
...
on_run(function (target)
    ...
    local rundir = "../../submit-cheriot/exercises-c++/08.type-confusion/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-cheriot/exercises-c++/08.type-confusion/debug"
