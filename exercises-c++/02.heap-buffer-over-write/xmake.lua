...
on_run(function (target)
    ...
    local rundir = "../../submit/exercises-c++/02.heap-buffer-over-write/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit/exercises-c++/02.heap-buffer-over-write/debug"
