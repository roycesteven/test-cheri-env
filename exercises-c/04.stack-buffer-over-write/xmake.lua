...
compartment("stack-buffer-over-write")
    ...
    add_files("stack-buffer-over-write.c")

-- Firmware image for the example.
firmware("stack-buffer-over-write-vulnerability")
    add_deps("stdio")
    add_deps("stack-buffer-over-write")
...
on_run(function (target)
    ...
    local rundir = "../../submit-cheriot/exercises-c/04.stack-buffer-over-write/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-cheriot/exercises-c/04.stack-buffer-over-write/debug"
