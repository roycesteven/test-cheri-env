...
on_run(function (target)
    ...
    local rundir = "../../submit-cheriot/exercises-c/06.use-after-free/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-cheriot/exercises-c/06.use-after-free/debug"
